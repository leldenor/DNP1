...
namespace FamilyInfo.Data
{
    public class FamilyServiceClient : IFamilyService
    {
        ...
        public async Task AddFamilyAsync(Family family)
        {
            ...
            var response = await client.PostAsync("http://dnp.metamate.me/Families", content);
        ...
        private async Task UpdateFamily(Family family)
        {
            ...
            var response = await client.PatchAsync($"http://dnp.metamate.me/Families/{family.StreetName}&{family.HouseNumber}", content);
            Console.WriteLine(response.StatusCode);
        }
    }
}